...
This document defines the **mandatory** development workflow for SwiftEspeak. Claude Code MUST follow these conventions for ALL code changes, commits, pull requests, and releases.
...
- **SwiftEspeak**: Swift wrapper for eSpeak-NG text-to-speech library

All Stovak Swift projects follow the **exact same workflow** for consistency.
